...
Special thanks to Brian Julius, Brian Bone, Shaun Standley, Rich Kinslow, Matt Rozek, Jonny Grinblat, Matt Marsh, Matt Stumbo, Valeria Salazar, Paige Arthur, and Ban Tieu
...
Hongman has been Ingenium's software architect since the beginning. There is not a bit of code in Ingenium that he hasn't guided, written or reviewed. 

### Mahmudur Khan: Lead Developer, DevOps

Khan is the current lead developer and DevOps engineer for Ingenium. 

## Historical Contributors

Lots of great people contributed to Ingenium over the years. Here they are in no paticular order:

- Lisa Watanabe
- Aaron Wright
- Christopher Korbel
- Christopher Eng
- Ahmad N (Andy) Abou-Harb
- David Feinberg
- Glenn Dayton
- Mike Spangler
- Min Liang (Jason) Kang 
- Lini Mestar
- Nicholas Lopez
- Paul Chung
- Thirupathi (Thi) Srinivasan
- Connor Francis
- Chun-Fang (Jennifer) Yang
- Dan Isla
- Joe Sweeney
- Simon Grigorian
- Nythi Udomkesmalee
...
!!! note "Open Ingenium Note"
    MTAK is part of AMPCS which is not open source.
...
!!! note "Open Ingenium Note"
    Ingenium References Scripts are being refactors into [Ingenium-lib](https://github.com/OpenIngenium/ingenium-lib){target="_blank"}
